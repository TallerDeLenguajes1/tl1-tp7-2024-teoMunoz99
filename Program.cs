...
DateTime nacimiento = new DateTime(1985,8,14);
DateTime ingreso = new DateTime(2009,9,13);
Empleado empleado1 = new Empleado("Pepe","Elcochino",nacimiento, 's', ingreso, 30000, Cargos.Administrativo);
empleado1.CalularAntiguedad();
empleado1.CalcularEdad();
empleado1.TiempoParaJubilarse();